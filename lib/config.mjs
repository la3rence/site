...
const envFlag = name => env[name] === "true";
const publicAnalyticsEnabled = process.env.NEXT_PUBLIC_ANALYTICS_ENABLE === "true";
const publicAnalyticsWebsiteId = process.env.NEXT_PUBLIC_ANALYTICS_ID || "";
const publicAdsenseURL = process.env.NEXT_PUBLIC_ADS_URL || "";
...
const config = {
  ...
  rewardURL: "https://qr.alipay.com/tsx12829sov5evioeg5j5fc",
  ...
  repo: "site",
  enableActivityPub:
    envFlag("ACTIVITYPUB_ENABLE") &&
    hasValue(env.ACTIVITYPUB_PUBLIC_KEY) &&
    hasValue(env.ACTIVITYPUB_PRIVATE_KEY) &&
    hasValue(env.MONGODB_URL),
  enableAnalytics: publicAnalyticsEnabled && hasValue(publicAnalyticsWebsiteId),
  enableAdsense: hasValue(publicAdsenseURL),
  enableMongo: hasValue(env.MONGODB_URL),
  enableNotes: hasValue(env.MONGODB_URL),
  enableNotesAdmin: hasValue(env.MONGODB_URL) && hasValue(env.ADMIN_TOKEN),
  enableVix: hasValue(env.QVIX_300_DAILY_API) && hasValue(env.QVIX_300_MIN_API),
  enableBuildInfo: false,
  enableToC: false,
  enableGitHubComment: true,
  analyticsWebsiteId: publicAnalyticsWebsiteId,
  adsenseURL: publicAdsenseURL,
  activityPubPublicKey: env.ACTIVITYPUB_PUBLIC_KEY || "",
  ethAddress: "0x95Bbb0b840be8a74BA3FDca9609d6F7FC22c2761",
  ...
  navItems: [
    ...
    {
      label: "GitHub",
      path: "https://github.com/la3rence",
    },
    {
      label: "Twitter",
      path: "https://twitter.com/la3rence",
    },
    {
      label: "RSS",
      path: "https://lawrenceli.me/atom.xml",
    },
    {
      label: "Locale",
    },
