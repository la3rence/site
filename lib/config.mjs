...
const config = {
  ...
  enableAnalytics:
    envFlag("NEXT_PUBLIC_ANALYTICS_ENABLE") && hasValue(env.NEXT_PUBLIC_ANALYTICS_ID),
  enableAdsense: hasValue(env.NEXT_PUBLIC_ADS_URL),
  ...
  analyticsWebsiteId: env.NEXT_PUBLIC_ANALYTICS_ID || "",
  adsenseURL: env.NEXT_PUBLIC_ADS_URL || "",
